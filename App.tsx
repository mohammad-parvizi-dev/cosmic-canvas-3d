  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 text-white">
      <header className="p-4 bg-gray-800 shadow-md">
        <h1 className="text-2xl font-bold text-center text-cyan-400">Interactive Particle Universe</h1>
      </header>
        ...
        <div className="flex flex-col items-center min-w-[150px] sm:min-w-[200px]">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              // setRegenerationKey(prevKey => prevKey + 1); // Regeneration now distinct
            }}
